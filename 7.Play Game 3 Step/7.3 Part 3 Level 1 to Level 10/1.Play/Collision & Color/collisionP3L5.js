...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L5");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L5", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L5")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L5", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L5");
}