...
public class saveF1L7 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L7;
	//*************************************************************************
	public TextMesh textResultLevelP2L7;
	//*************************************************************************
	public TextMesh textResultLevelP3L7;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L7.text = "" + PlayerPrefs.GetInt("ScoreSubP1L7");
		//Score Show Part 2 L1-L10
		textResultLevelP2L7.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L7");
		//Score Show Part 3 L1-L10
		textResultLevelP3L7.text = "" + PlayerPrefs.GetInt("ScoreLevelP3L4");
	}
	...
	public string Name;
	void save(){
		stringG = "object1,object2,object3,object4,object5,object6,object7,object8";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object7")		
				{
					WriteToFile (SaveName, stringG+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
