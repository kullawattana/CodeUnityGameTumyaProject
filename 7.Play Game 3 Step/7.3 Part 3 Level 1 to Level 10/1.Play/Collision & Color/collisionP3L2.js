...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L2");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L2", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L2")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L2", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L2");
}