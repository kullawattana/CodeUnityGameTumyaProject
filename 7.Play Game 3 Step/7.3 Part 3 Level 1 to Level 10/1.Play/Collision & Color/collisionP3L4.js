...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L4");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L4", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L4")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L4", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L4");
}