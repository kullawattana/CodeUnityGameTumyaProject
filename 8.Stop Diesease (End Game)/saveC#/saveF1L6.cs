...
public class saveF1L6 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L6;
	//*************************************************************************
	public TextMesh textResultLevelP2L6;
	//*************************************************************************
	public TextMesh textResultLevelP3L6;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L6.text = "" + PlayerPrefs.GetInt("ScoreSubP1L6");
		//Score Show Part 2 L1-L10
		textResultLevelP2L6.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L6");
	...
	public string Name;
	void save(){
		stringF = "object1,object2,object3,object4,object5,object6,object7";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object6")		
				{
					WriteToFile (SaveName, stringF+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
