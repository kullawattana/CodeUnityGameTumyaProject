...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t
.state("index",{url:"/",templateUrl:"templates/dashboard.html"})
.state("tablesHallOfFrame",{url:"/tablesHallOfFrame",templateUrl:"templates/tablesHallOfFrame.html"})
.state("tablesKebya",{url:"/tablesKebya",templateUrl:"templates/tablesKebya.html"})
.state("tablesSubya",{url:"/tablesSubya",templateUrl:"templates/tablesSubya.html"})
.state("tablesTumya",{url:"/tablesTumya",templateUrl:"templates/tablesTumya.html"})
.state("tablesScoreResult",{url:"/tablesScoreResult",templateUrl:"templates/tablesScoreResult.html"})
}]);
