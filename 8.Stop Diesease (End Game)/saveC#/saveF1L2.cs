...
public class saveF1L2 : MonoBehaviour {
	//Load Level
	...
	//--------------------------->
	public TextMesh textResultLevelP1L2;
	//*************************************************************************
	public TextMesh textResultLevelP2L2;
	//*************************************************************************
	public TextMesh textResultLevelP3L2;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L2.text = "" + PlayerPrefs.GetInt("ScoreSubP1L2");
		//Score Show Part 2 L1-L10
		textResultLevelP2L2.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L2");
	...
	void save(){
		...
		stringB = "object1,object2,object3";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object2")		
				{
					WriteToFile (SaveName, stringB+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
