...
public class saveF1L3 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L3;
	//*************************************************************************
	public TextMesh textResultLevelP2L3;
	//*************************************************************************
	public TextMesh textResultLevelP3L3;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L3.text = "" + PlayerPrefs.GetInt("ScoreSubP1L3");
		//Score Show Part 2 L1-L10
		textResultLevelP2L3.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L3");
	...
	public string Name;
	void save(){
		stringC = "object1,object2,object3,object4";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object3")		
				{
					WriteToFile (SaveName, stringC+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
