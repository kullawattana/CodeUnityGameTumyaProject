...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L7");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L7", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L7")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L7", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L7");
}