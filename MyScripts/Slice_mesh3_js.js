...
function SliceIt() 
{
	...
	collider.height = mesh.bounds.size.y*0.8; // reset size, bit smaller than real
	collider.center = mesh.bounds.center; // reset center
	...
	clone.collider.height = meshSlice.bounds.size.y*0.8; // reset size
	clone.collider.center = meshSlice.bounds.center; // reset center
	...
	clone.rigidbody.mass = (meshSlice.bounds.size.x*meshSlice.bounds.size.y*meshSlice.bounds.size.z)*initialDensity;
