...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L1");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L1", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L1")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L1", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L1");
}