...
public class saveF1L8 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L8;
	//*************************************************************************
	public TextMesh textResultLevelP2L8;
	//*************************************************************************
	public TextMesh textResultLevelP3L8;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L8.text = "" + PlayerPrefs.GetInt("ScoreSubP1L8");
		//Score Show Part 2 L1-L10
		textResultLevelP2L8.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L8");
	...
	public string Name;
	void save(){
		stringH = "object1,object2,object3,object4,object5,object6,object7,object8,object9";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object8")		
				{
					WriteToFile (SaveName, stringH+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
