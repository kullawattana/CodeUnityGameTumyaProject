...
function gameOver() {
	PlayerPrefs.GetInt("ScoreItem1-P2L2-R");						//My Score Item 1
	PlayerPrefs.SetInt("ScoreItem1-P2L2-R", scoreCount_L1);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem2-P2L2-R");						//My Score Item 2
	PlayerPrefs.SetInt("ScoreItem2-P2L2-R", scoreCount_L2);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem3-P2L2-R");						//My Score Item 3
	PlayerPrefs.SetInt("ScoreItem3-P2L2-R", scoreCount_L3);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem4-P2L2-R");						//My Score Item 4
	PlayerPrefs.SetInt("ScoreItem4-P2L2-R", scoreCount_L4);
	//*******************************************************************************************
	
	PlayerPrefs.GetInt("ScoreLevel_P2L2-R");						//My Score
	PlayerPrefs.SetInt("ScoreLevel_P2L2-R", scoreResult_right);
}