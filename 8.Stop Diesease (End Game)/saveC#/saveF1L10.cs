...
public class saveF1L10 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L10;
	//*************************************************************************
	public TextMesh textResultLevelP2L10;
	//*************************************************************************
	public TextMesh textResultLevelP3L10;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L10.text = "" + PlayerPrefs.GetInt("ScoreSubP1L10");
		//Score Show Part 2 L1-L10
		textResultLevelP2L10.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L10");
	...
	void OnTriggerEnter(Collider other){
		if (other.tag == "next") {
			Application.LoadLevel("AnimationComplete");	
			save();
		}
	}
	...
	void save(){
		...
		stringSpecial = "object1,object2,object3,object4,object5,object6,object7,object8,object9,object10";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object9")		
				{
					WriteToFile (SaveName, stringSpecial+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
