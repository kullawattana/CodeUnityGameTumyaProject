...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L10");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L10", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L10")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L10", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L10");
}