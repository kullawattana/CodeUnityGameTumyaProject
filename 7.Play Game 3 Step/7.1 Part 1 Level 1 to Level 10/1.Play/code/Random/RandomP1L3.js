...
function Awake()
{
     randomObject = new Array(herBalItem1, herBalItem2, herBalItem3, herBalItem4,herBalItem5, herBalItem6, herBalItem7);
}
...
{    	
        ...
        addXPos = Random.Range(-10.0f, 10.0f);								//Random Position
