...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L6");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L6", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L6")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L6", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L6");
}