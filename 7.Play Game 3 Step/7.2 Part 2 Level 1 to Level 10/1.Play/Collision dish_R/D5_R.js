...
function gameOver() {
	PlayerPrefs.GetInt("ScoreItem1-P2L5-R");						//My Score Item 1
	PlayerPrefs.SetInt("ScoreItem1-P2L5-R", scoreCount_L1);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem2-P2L5-R");						//My Score Item 2
	PlayerPrefs.SetInt("ScoreItem2-P2L5-R", scoreCount_L2);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem3-P2L5-R");						//My Score Item 3
	PlayerPrefs.SetInt("ScoreItem3-P2L5-R", scoreCount_L3);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem4-P2L5-R");						//My Score Item 4
	PlayerPrefs.SetInt("ScoreItem4-P2L5-R", scoreCount_L4);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem5-P2L5-R");						//My Score Item 5
	PlayerPrefs.SetInt("ScoreItem5-P2L5-R", scoreCount_L5);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem6-P2L5-R");						//My Score Item 6
	PlayerPrefs.SetInt("ScoreItem6-P2L5-R", scoreCount_L6);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem7-P2L5-R");						//My Score Item 7
	PlayerPrefs.SetInt("ScoreItem7-P2L5-R", scoreCount_L7);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem8-P2L5-R");						//My Score Item 8
	PlayerPrefs.SetInt("ScoreItem8-P2L5-R", scoreCount_L8);
	//*******************************************************************************************
	
	PlayerPrefs.GetInt("ScoreLevel_P2L5-R");						//My Score
	PlayerPrefs.SetInt("ScoreLevel_P2L5-R", scoreResult_right);
}