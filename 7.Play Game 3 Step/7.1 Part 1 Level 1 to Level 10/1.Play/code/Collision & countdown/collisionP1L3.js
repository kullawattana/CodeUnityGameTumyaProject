...
//---------------------------------------------------------------------------------------------------------->
function gameOver() {
	PlayerPrefs.GetInt("ScoreItem1-P1L3");						//My Score Item 1
	PlayerPrefs.SetInt("ScoreItem1-P1L3", scoreCountItem1);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem2-P1L3");						//My Score Item 2
	PlayerPrefs.SetInt("ScoreItem2-P1L3", scoreCountItem2);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem3-P1L3");						//My Score Item 3
	PlayerPrefs.SetInt("ScoreItem3-P1L3", scoreCountItem3);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem4-P1L3");						//My Score Item 4
	PlayerPrefs.SetInt("ScoreItem4-P1L3", scoreCountItem4);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem5-P1L3");						//My Score Item 5
	PlayerPrefs.SetInt("ScoreItem5-P1L3", scoreCountItem5);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem6-P1L3");						//My Score Item 6
	PlayerPrefs.SetInt("ScoreItem6-P1L3", scoreCountItem6);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem7-P1L3");						//My Score Item 7
	PlayerPrefs.SetInt("ScoreItem7-P1L3", scoreCountItem7);
	//*******************************************************************************************
		
	PlayerPrefs.GetInt("ScoreSubP1L3");							//My Score
	PlayerPrefs.SetInt("ScoreSubP1L3", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP1L3")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP1L3", scoreResult);			//Set Maximum Score
	}		
	Application.LoadLevel("Part1 CL1-3");
}