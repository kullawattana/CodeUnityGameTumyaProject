...
public class saveF1L1 : MonoBehaviour {
	//Load Level
	...
	//--------------------------->
	public TextMesh textResultLevelP1L1;
	//*************************************************************************
	public TextMesh textResultLevelP2L1;
	//*************************************************************************
	public TextMesh textResultLevelP3L1;
	//--------------------------->
	...
	void save(){
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object1")		
				{
					WriteToFile (SaveName, stringA+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
