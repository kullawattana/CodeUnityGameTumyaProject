...
public class saveF1L4 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L4;
	//*************************************************************************
	public TextMesh textResultLevelP2L4;
	//*************************************************************************
	public TextMesh textResultLevelP3L4;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L4.text = "" + PlayerPrefs.GetInt("ScoreSubP1L4");
		//Score Show Part 2 L1-L10
		textResultLevelP2L4.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L4");
	...
	public string Name;
	void save(){
		stringD = "object1,object2,object3,object4,object5";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object4")		
				{
					WriteToFile (SaveName, stringD+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
