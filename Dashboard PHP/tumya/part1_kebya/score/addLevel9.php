<?php 
		...
		$score_item_5 = mysql_real_escape_string($_GET['score_item_5'], $db); 
		$score_item_6 = mysql_real_escape_string($_GET['score_item_6'], $db); 
		$score_item_7 = mysql_real_escape_string($_GET['score_item_7'], $db); 
		$score_item_8 = mysql_real_escape_string($_GET['score_item_8'], $db); 
		$score_item_9 = mysql_real_escape_string($_GET['score_item_9'], $db); 
		$score_item_10 = mysql_real_escape_string($_GET['score_item_10'], $db); 
		$weight_result = mysql_real_escape_string($_GET['weight_result'], $db); 
		
		$query = "insert into level_9 values ('$id', '$username' , '$score_result', '$score_item_1', '$score_item_2', 
