...
function gameOver() {
	PlayerPrefs.GetInt("ScoreLevelP3L8");						//My Score
	PlayerPrefs.SetInt("ScoreLevelP3L8", scoreResult);
	//****************************************************
	if(scoreResult > PlayerPrefs.GetInt("MaxScoreP3L8")) 			//Maximum Score
	{ 
		PlayerPrefs.SetInt("MaxScoreP3L8", scoreResult);			//Set Maximum Score
	}		
	
	Application.LoadLevel("ScoreResultP3-L8");
}