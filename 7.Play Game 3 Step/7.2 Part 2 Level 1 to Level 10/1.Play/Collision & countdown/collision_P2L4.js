...
function gameOver() {
	...
	PlayerPrefs.SetInt("ScoreItem1-P2L4", scoreCount_1);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem2-P2L4");						//My Score Item 2
	PlayerPrefs.SetInt("ScoreItem2-P2L4", scoreCount_2);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem3-P2L4");						//My Score Item 3
	PlayerPrefs.SetInt("ScoreItem3-P2L4", scoreCount_3);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem4-P2L4");						//My Score Item 4
	PlayerPrefs.SetInt("ScoreItem4-P2L4", scoreCount_4);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem5-P2L4");						//My Score Item 5
	PlayerPrefs.SetInt("ScoreItem5-P2L4", scoreCount_5);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem6-P2L4");						//My Score Item 6
	PlayerPrefs.SetInt("ScoreItem6-P2L4", scoreCount_6);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem7-P2L4");						//My Score Item 7
	PlayerPrefs.SetInt("ScoreItem7-P2L4", scoreCount_7);
	//*******************************************************************************************
	
	PlayerPrefs.GetInt("ScoreLevel_P2L4");						//My Score
	PlayerPrefs.SetInt("ScoreLevel_P2L4", scoreResult);
	
	if(scoreResult > PlayerPrefs.GetInt("Score_P2L4")) 			//If Maximum Score
	{ 
		PlayerPrefs.SetInt("Score_P2L4", scoreResult);			//Set Maximum Score
	}		
	Application.LoadLevel("scoreResultP2-L4");					//Next to Coclision Score Level
}