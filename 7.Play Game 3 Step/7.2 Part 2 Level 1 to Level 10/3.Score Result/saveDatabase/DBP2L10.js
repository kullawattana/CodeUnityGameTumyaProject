...
function Awake() { 
	textResultLevelP2L10.text = "" + PlayerPrefs.GetInt("ScoreLevelP2L10");				//My Score
	textMaxScore.text = "" + PlayerPrefs.GetInt("MaxScoreP2L10");						//Maximum Score
}
...
function send() {							//Send Score to Database
    ...
    form.AddField("score", textResultLevelP2L10.text);
    form.AddField("username", textMaxScore.text);
    var url = "http://localhost/unity_test/SaveScoreP2L10.php";
    var w = WWW(url, form);
    yield w;
    Debug.Log (w.text);
}