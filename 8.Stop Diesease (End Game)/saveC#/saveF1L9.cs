...
public class saveF1L9 : MonoBehaviour {
	//Load Level
	...
	*/
	//--------------------------->
	public TextMesh textResultLevelP1L9;
	//*************************************************************************
	public TextMesh textResultLevelP2L9;
	//*************************************************************************
	public TextMesh textResultLevelP3L9;
	//--------------------------->
	...
	void Awake() {
		...
		textResultLevelP1L9.text = "" + PlayerPrefs.GetInt("ScoreSubP1L9");
		//Score Show Part 2 L1-L10
		textResultLevelP2L9.text = "" + PlayerPrefs.GetInt("ScoreLevel_P2L9");
	...
	public string Name;
	void save(){
		stringI = "object1,object2,object3,object4,object5,object6,object7,object8,object9,object10";
		...
		foreach (string SaveString in ObjectsLoaded) 
		{
			if(SaveString != null)
			{
				...
				if(SaveString == "object9")		
				{
					WriteToFile (SaveName, stringI+","+Name);				//write object1
					WriteToFile (SaveScoreName, L1+L2+L3+L4+L5+L6+L7+L8+L9+L10);
				}
			}
		}
