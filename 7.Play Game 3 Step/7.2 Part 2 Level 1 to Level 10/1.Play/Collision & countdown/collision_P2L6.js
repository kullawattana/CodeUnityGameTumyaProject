...
var scoreCount_8 : int = 0;							//Count Score Item 4
//-------------------------------------------------------------------------------------------------->							
...
function gameOver() {
	...
	PlayerPrefs.SetInt("ScoreItem1-P2L6", scoreCount_1);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem2-P2L6");						//My Score Item 2
	PlayerPrefs.SetInt("ScoreItem2-P2L6", scoreCount_2);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem3-P2L6");						//My Score Item 3
	PlayerPrefs.SetInt("ScoreItem3-P2L6", scoreCount_3);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem4-P2L6");						//My Score Item 4
	PlayerPrefs.SetInt("ScoreItem4-P2L6", scoreCount_4);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem5-P2L6");						//My Score Item 5
	PlayerPrefs.SetInt("ScoreItem5-P2L6", scoreCount_5);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem6-P2L6");						//My Score Item 6
	PlayerPrefs.SetInt("ScoreItem6-P2L6", scoreCount_6);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem7-P2L6");						//My Score Item 7
	PlayerPrefs.SetInt("ScoreItem7-P2L6", scoreCount_7);
	//*******************************************************************************************
	PlayerPrefs.GetInt("ScoreItem8-P2L6");						//My Score Item 8
	PlayerPrefs.SetInt("ScoreItem8-P2L6", scoreCount_8);
	//*******************************************************************************************
	
	PlayerPrefs.GetInt("ScoreLevel_P2L6");						//My Score
	PlayerPrefs.SetInt("ScoreLevel_P2L6", scoreResult);
	
	if(scoreResult > PlayerPrefs.GetInt("Score_P2L6")) 			//If Maximum Score
	{ 
		PlayerPrefs.SetInt("Score_P2L6", scoreResult);			//Set Maximum Score
	}		
	Application.LoadLevel("scoreResultP2-L6");					//Next to Coclision Score Level
}