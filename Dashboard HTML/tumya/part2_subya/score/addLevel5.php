<?php 
		...
		$query = "insert into level_5 values ('$id', '$username' , '$score_result', '$score_item_1', '$score_item_2', 
		'$score_item_3', '$score_item_4', '$score_item_5', 
		'$score_item_6', '$score_item_7', '$score_item_8', '$weight_result');"; 
