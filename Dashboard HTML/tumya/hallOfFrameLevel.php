<?php 
		...
		if($level_flag = "1"){
			...
			$query = "insert into hall_of_frame_part_1 values ('', '$id_user' , '$username', '$score_p1_l1', '$score_p2_l1', '$score_p3_l1');"; 
			...
			$query = "insert into hall_of_frame_part_2 values ('', '$id_user' , '$username', '$score_p1_l2', '$score_p2_l2', '$score_p3_l2');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		} 
			...
			$query = "insert into hall_of_frame_part_3 values ('', '$id_user' , '$username', '$score_p1_l3', '$score_p2_l3', '$score_p3_l3');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_4 values ('', '$id_user' , '$username', '$score_p1_l4', '$score_p2_l4', '$score_p3_l4');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_5 values ('', '$id_user' , '$username', '$score_p1_l5', '$score_p2_l5', '$score_p3_l5');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_6 values ('', '$id_user' , '$username', '$score_p1_l6', '$score_p2_l6', '$score_p3_l6');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_7 values ('', '$id_user' , '$username', '$score_p1_l7', '$score_p2_l7', '$score_p3_l7');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_8 values ('', '$id_user' , '$username', '$score_p1_l8', '$score_p2_l8', '$score_p3_l8');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_9 values ('', '$id_user' , '$username', '$score_p1_l9', '$score_p2_l9', '$score_p3_l9');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
			...
			$query = "insert into hall_of_frame_part_10 values ('', '$id_user' , '$username', '$score_p1_l10', '$score_p2_l10', '$score_p3_l10');"; 
			$result = mysql_query($query) or die('Query failed: ' . mysql_error());
		}
?>